"""Adana'a özel demografi adapter'ı.

Adana için de belediye CKAN'ından mahalle düzeyinde nüfus/yaş verisi
...
kaynak notlarını ve CSV yollarını taşır):
  ...
  - `ilce_nufus.csv`: Seyhan, Yüreğir, Çukurova, Sarıçam ilçelerinin 2025 ADNKS toplam nüfusu.
    Tüm il ilçelerinin nüfus toplamı resmi il toplamına (2.283.609) eşit çıktı
    (ilçe rakamlarının doğrulanması). **Önemli sınırlama**: yaşlı/çocuk
    oranı için ilçe bazlı bir TÜİK yayını bulunamadı - Adana İLİ'nin 2025
    geniş yaş grubu dağılımı (0-14: 502.239, 65+: 241.760; 15-64 ile toplamı il
    toplamına eşit) her ilçeye aynı şekilde uygulandı (çocuk %21,99, yaşlı
    %10,59). Gerçek ilçe bazlı oran il ortalamasından sapabilir. Yaş grubu
  ...
  - `sege_2022_ilce.csv`: T.C. Sanayi ve Teknoloji Bakanlığı'nın resmi
    SEGE-2022 raporundaki (baka.gov.tr üzerinden erişilen PDF, Adana
    tablosu) Seyhan (Türkiye geneli 42.), Çukurova (76.), Sarıçam (149.) ve Yüreğir (203.) skorları.
...
Doğrulama: gerçek OSM özütüyle (163 mahalle, 22.986 yol segmenti) `validate_city.py` ve
