"""Konya district-level ADNKS age shares and SEGE-2022 reference data.

Age-group counts: 2023 TÜİK ADNKS, as reproduced in the İŞKUR activity report
(https://media.iskur.gov.tr/94797/konya.pdf). Socioeconomic ranks/scores: T.C. Sanayi ve Teknoloji Bakanlığı,
